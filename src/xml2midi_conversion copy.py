...
def process_score(in_str):
    ...
    print()
    print("Saved basic MIDI file to " + "".join([in_str, '_modified.midi']))
    ...
    print("Saved modified MIDI file to " + "".join([in_str, '_modified.midi']))
    midi.write("".join([in_str, '_modified.midi']))
    print()

    return "".join([in_str, '_modified.midi'])
