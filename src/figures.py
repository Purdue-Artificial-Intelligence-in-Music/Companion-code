...
live_audio, _ = librosa.load('data/bach/live/constant_tempo.wav', sr=sr, mono=True)
ref_audio, _ = librosa.load('data/bach/synthesized/track0.wav', sr=sr, mono=True)
comp_audio, _ = librosa.load('data/bach/synthesized/track1.wav', sr=sr, mono=True)
...
fig.savefig('data/bach/figures/audio.png', bbox_inches='tight', pad_inches=pad_inches, dpi=dpi)
plt.close(fig)
...
fig.savefig('data/bach/figures/live_chroma.png', bbox_inches='tight', pad_inches=pad_inches, dpi=dpi)
plt.close(fig)
...
fig.subplots_adjust(hspace=0.25)
fig.colorbar(img, ax=ax)
fig.savefig('data/bach/figures/ref_chroma.png', bbox_inches='tight', pad_inches=pad_inches, dpi=dpi)
plt.close(fig)
...
fig.subplots_adjust(hspace=0.25)
fig.colorbar(img, ax=ax)
fig.savefig('data/bach/figures/live_ref_chroma.png', bbox_inches='tight', pad_inches=pad_inches, dpi=dpi)
plt.close(fig)
