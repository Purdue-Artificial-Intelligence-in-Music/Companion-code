...
stats_df = pd.DataFrame({
    ...
    'Alignment Error': alignment_stats.values.tolist() + [df['abs_alignment_error'].mean()],
    'Accompaniment Error': accompaniment_stats.values.tolist() + [df['abs_accompaniment_error'].mean()]
})
