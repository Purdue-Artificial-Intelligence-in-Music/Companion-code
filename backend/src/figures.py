...
fig.savefig(
    "data/bach/figures/audio.png", bbox_inches="tight", pad_inches=pad_inches, dpi=dpi
)
plt.close(fig)
...
fig.savefig(
    "data/bach/figures/live_chroma.png",
    bbox_inches="tight",
...
fig.colorbar(img, ax=ax)
fig.savefig(
    "data/bach/figures/ref_chroma.png",
    bbox_inches="tight",
    pad_inches=pad_inches,
    dpi=dpi,
)
...
fig.colorbar(img, ax=ax)
fig.savefig(
    "data/bach/figures/live_ref_chroma.png",
    bbox_inches="tight",
    pad_inches=pad_inches,
    dpi=dpi,
)
