...
#             result_df["estimated_ref"],
#             pd.Series(exp_estimated_ref, name="estimated_ref"),
#         )
#         pd.testing.assert_series_equal(
#             result_df["alignment_error"],
#             pd.Series(exp_alignment_error, name="alignment_error"),
#         )
...
#         self.assertTrue(
#             all(
#                 col in result_empty_df.columns
#                 for col in ["estimated_ref", "alignment_error"]
#             )
#         )
