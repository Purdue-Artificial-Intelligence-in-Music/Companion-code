...
try:
    ...
    print(
        'remember to use SET PYTHONPATH="C:\\Users\\Nick\\github\\Nick-Ko-Companion-code\\src"'
    )
...
def main() -> None:
    ...
    timeMeasured = np.array(
        [measure_elapsed_time(duration) for duration in maxDurations]
    )
