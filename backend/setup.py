...
user_input = input('Would you like to download and install the FluidR3_GM soundfont? (y/n): ')
...
user_input = input('Would you like to download and install FluidSynth for Windows? (y/n): ')
if user_input.lower() == 'y':
